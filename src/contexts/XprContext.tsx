...
<dyad-write path="src/pages/AdminHub.tsx" description="Adding the 'Promo Codes' administration tab inside the AdminHub page, supporting creating free-access and percentage-off codes.">
"use client";
    ...
    <div className="min-h-screen bg-[#06030e] text-white overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 md:px-6 py-12 pt-36 md:pt-44 max-w-6xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {/* Promo Codes Tab */}
          <TabsContent value="codes" className="space-y-8 mt-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
