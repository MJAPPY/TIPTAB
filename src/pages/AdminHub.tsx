      ...
      <main className="container mx-auto px-6 py-12 pt-40">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Platform Vitals */}
            <Card className="bg-[#120a21] border-white/5 rounded-[32px] overflow-hidden shadow-2xl">
              <CardHeader className="p-8 pb-4">
                <CardTitle className="text-xl font-black flex items-center gap-3 tracking-tight">
                  <Activity className="h-5 w-5 text-purple-500" /> PLATFORM VITALS
                </CardTitle>
              </CardHeader>
              <CardContent className="p-8 pt-2 space-y-8">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-6 rounded-[24px] bg-[#1a112d] border border-white/5 space-y-2">
                    ...
                    <p className="text-4xl font-black text-green-500">+14%</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-white/40">Total TAB Tipped</span>
                    <span className="text-sm font-black text-orange-500">4.2M TAB</span>
                  </div>
            ...
            <Card className="bg-[#120a21] border-white/5 rounded-[32px] overflow-hidden shadow-2xl">
              <CardHeader className="p-8 pb-2">
                <CardTitle className="text-xl font-black flex items-center gap-3 tracking-tight">
                  <Settings className="h-5 w-5 text-orange-500" /> NETWORK CONFIG
                </CardTitle>
                <CardDescription className="text-white/40 font-medium">Global platform parameters</CardDescription>
              </CardHeader>
              <CardContent className="p-8 space-y-8">
                <div className="space-y-4">
                  <div className="relative inline-block">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-white/40">MEMBERSHIP FEE (XPR)</Label>
                    <div className="absolute -bottom-1 left-0 w-1/2 h-0.5 bg-red-500" />
                  </div>
                  <div className="flex gap-4">
                    <Input 
                      ...
                      className="bg-[#1a112d] border-white/10 rounded-2xl font-black text-xl h-16 px-6 focus:ring-orange-500/50"
                    />
                    <Button 
                      onClick={handleUpdateFee} 
                      className="bg-orange-500 hover:bg-orange-600 rounded-2xl px-8 h-16 font-black text-lg shadow-lg shadow-orange-500/20"
                    >
                      Update
                    </Button>
                  </div>
                  <p className="text-[10px] text-white/30 italic font-medium">Changes will reflect in Membership Modals immediately.</p>
                </div>
          ...
          <div className="lg:col-span-8">
            <Card className="bg-[#120a21] border-white/5 rounded-[40px] overflow-hidden shadow-2xl min-h-[840px]">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="relative w-full md:w-80">
                    ...
                    <Input 
                      ...
                      className="pl-14 bg-[#1a112d] border-white/10 rounded-2xl h-14 focus:ring-purple-500/50"
                    />
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-white/[0.02]">
                      <tr>
                        <th className="px-10 py-6 text-left text-[10px] font-black uppercase tracking-widest text-white/30">Creator</th>
                        <th className="px-10 py-6 text-left text-[10px] font-black uppercase tracking-widest text-white/30">Category</th>
                        <th className="px-10 py-6 text-left text-[10px] font-black uppercase tracking-widest text-white/30">Status</th>
                        <th className="px-10 py-6 text-right text-[10px] font-black uppercase tracking-widest text-white/30">Actions</th>
                      </tr>
                    </thead>
                          ...
                          <tr key={creator.id} className="group hover:bg-white/[0.02] transition-colors">
                            <td className="px-10 py-8">
                              <div className="flex items-center gap-5">
                                <div className={cn("h-14 w-14 rounded-2xl flex items-center justify-center text-sm font-black border-2 border-white/10", creator.color)}>
                                  {creator.avatar}
                                </div>
                                <div>
                            ...
                            <td className="px-10 py-8">
                              <div className="flex items-center gap-2">
                                {isBanned ? (
                                  <div className="flex items-center gap-2 text-red-500 bg-red-500/10 px-3 py-1.5 rounded-xl border border-red-500/20 font-black text-[10px] uppercase">
                                    <Lock className="h-3 w-3" /> Banned
                                  </div>
                                ) : (
                                  <div className="flex items-center gap-2 text-green-500 bg-green-500/10 px-3 py-1.5 rounded-xl border border-green-500/20 font-black text-[10px] uppercase">
                            ...
                            <td className="px-10 py-8 text-right">
                              <div className="flex items-center justify-end gap-3">
                                <Button 
                                  ...
                                  className={cn(
                                    "h-12 w-12 rounded-2xl transition-all border border-white/5",
                                    isBanned 
                                ...
                                <Button variant="ghost" size="icon" className="h-12 w-12 rounded-2xl bg-white/5 text-white/40 border border-white/5">
