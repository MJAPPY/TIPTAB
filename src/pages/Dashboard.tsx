            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="analytics" className="space-y-8 mt-0 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="bg-[#130b21] border-white/10 text-white rounded-[24px] overflow-hidden group">
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-3xl font-black group-hover:text-orange-500 transition-colors">128,450 <span className="text-orange-500 text-sm">XPR</span></CardTitle>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="bg-[#130b21] border-white/10 text-white rounded-[24px] overflow-hidden group">
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-3xl font-black group-hover:text-purple-500 transition-colors">42</CardTitle>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="bg-[#130b21] border-white/10 text-white rounded-[24px] overflow-hidden group">
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-3xl font-black group-hover:text-orange-500 transition-colors">1.2k</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <div className="bg-[#130b21] border border-white/10 rounded-[32px] p-8 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold mb-6 relative z-10">Recent Tips</h3>
                  <div className="space-y-4 relative z-10">
                    {[
                      ...
                      <div key={i} className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5 hover:border-white/10 transition-all hover:bg-white/[0.07]">
                        <div className="flex items-center gap-4">
                   ...
                   <div className="max-w-xs space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3 text-sm text-green-500 font-bold bg-green-500/5 p-3 rounded-xl border border-green-500/10">
                          <Zap className="h-5 w-5" /> Zero Network Fees
                        </div>
                        <div className="flex items-center gap-3 text-sm text-purple-500 font-bold bg-purple-500/5 p-3 rounded-xl border border-purple-500/10">
                          <Zap className="h-5 w-5" /> Instant Settlement
                        </div>
                      </div>
                   </div>
                </div>
              ...
              <TabsContent value="payouts" className="mt-0 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="bg-[#130b21] border border-white/10 rounded-[32px] p-20 text-center">
                  <div className="h-20 w-20 rounded-3xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mx-auto mb-6">
                    <Wallet className="h-10 w-10 text-purple-500" />
                  </div>
                  <h3 className="text-2xl font-bold mb-2">Payouts & Wallet</h3>
                  <p className="text-white/40">This feature is coming soon to the XPR Network.</p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="account" className="mt-0 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="bg-[#130b21] border border-white/10 rounded-[32px] p-20 text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-2">Account Preferences</h3>
                  <p className="text-white/40">Advanced security and notification settings coming soon.</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
