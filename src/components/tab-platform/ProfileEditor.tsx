                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent className="bg-[#1a102d] border-white/10 text-white rounded-xl">
                        {["Delivery", "Hospitality", "Fitness", "Food", "Reviewing", "Content", "Dev", "Art", "Education", "Gaming", "Music", "Sports", "Fishing", "Property Reno", "Automotive", "Realty", "Service", "Other"].map((cat) => (
